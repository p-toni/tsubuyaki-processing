...
def run_search(brief,seed,out_dir:Path,selector:Optional[PairwiseSelector]=None):
    ...
    for route in brief['routes']:
        for i in range(int(brief.get('starts_per_route',3))):
            cid=f'{route[:1].upper()}S{i+1}'; cand=None
