...
from pairwise_selector import PairwiseSelector, DeterministicTemporalSelector, RecordedDecisionSelector
...
def main():
    ...
    if args.blind_decisions_dir: selector=RecordedDecisionSelector(decode_blind_decisions(Path(args.blind_decisions_dir)),fallback=selector)
